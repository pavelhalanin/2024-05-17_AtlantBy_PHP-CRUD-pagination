...
<div class="container">
    <form class="form" action="/inv_docs/delete/delete-script.php" method="POST">
        <h2>Удаление записи из БД</h2>
        <div class="form__div">
        ...
        <button class="form__button" type="success">Удалить из базы</button>
    </form>
</div>