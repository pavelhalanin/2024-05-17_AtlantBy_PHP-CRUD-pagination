<?php
$SEO_TITLE = 'Result update inv_docs';
...
if ($conn->query($SQL) != TRUE) {
    ...
    <div class="container">
        <p class="p__error">Элемент не обновлен в БД</p>
    ...
    <div class="container">
        <p class="p__success">Элемент обновлен в БД</p>
